...
class Index
{
    ...
    public function test()
    {
        ...
        //     'GENDER'    => 'male'
        // ];
        // $res = $model->allowField(['COURSE','SCORE'])->save($data);
        // dump($res);
        // $res = TestTbGrade::create([
        //     'USER_NAME' => '测试',
        //     'COURSE'    => '02',
        //     'SCORE'     => '69',
        //     // 'GENDER'    => 'male'
        // ]);
        $res = TestTbGrade::where(['COURSE'=>'02','SCORE'=>69])
            ->update(['USER_NAME' => '测试','COURSE'=>'02','SCORE'=>'99']);
        // halt($res);
    }
}
